...
/**
 * A notification bell component that displays a badge with unread count
...
/**
 * Default state with unread notifications showing the badge count.
 * Click the bell to open the dropdown showing all notifications with timestamps.
 */
